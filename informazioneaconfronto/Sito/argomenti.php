<html>
 ...
 <ul class="nav navbar-nav navbar-right"><li><a href="confronta_notizie.php">CONFRONTA NOTIZIE!</a></li></ul>
         ...
         <div class="col-md-7">
            <?php           
            $args = array();
            echo"<div class='page-header'><h3> Risultati per: ";
            ...
            $query = "select distinct Link, Title, Summary, Image_path,pubdate, sito from articolo, contiene ";
            ...
            for($i=0; $i<$n; $i++){
                if($i<$n-1){
                    $query = $query."summary like '% ".$args[$i]." %' or summary like '% ".ucwords($args[$i])." %' or ";
                }else{
            ...
            $query = $query." order by pubdate, categoria;";
            mysql_query("SET CHARACTER SET 'utf8'");
                ...
                for($j = 0; $j<$n; $j++){
                    $art = mysql_fetch_row($res);                    
                            ...
                            echo "<br><b>".$art[2]."</b>";
                            echo"</div>";
                            echo"<div class='panel-footer'><div align='right'><a href='".$art[5]."'>".$art[5]."</a>, ".$art[4]."</div></div>";
                            print("</div>");
                }
            ?>
